...
IUSE="+eme-free hardened +privacy hwaccel jack pulseaudio selinux test -system-zlib -system-bz2 -system-hunspell -system-ffi -system-pixman -system-jpeg -system-libevent +webrtc"
RESTRICT="mirror"
